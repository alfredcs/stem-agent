...
// ---------------------------------------------------------------------------
// Agent Core Interface — Layer 3 public contract
// ---------------------------------------------------------------------------
...
export interface IStemAgent {
  ...
  process(
    taskId: string,
    message: import("./message.js").AgentMessage,
    principal?: import("./security.js").Principal | null,
  ): Promise<import("./message.js").AgentResponse>;

  /** Stream a response for a task. */
  stream(
    taskId: string,
    message: import("./message.js").AgentMessage,
  ): AsyncIterable<import("./message.js").AgentResponse>;
